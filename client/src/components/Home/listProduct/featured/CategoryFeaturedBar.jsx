...
import '../Product/CategoryBar.scss';

const CategoryFeaturedBar = ({ featured, totalProducts, onSortChange, onToggleFilters, filtersVisible }) => {
  ...
  return (
    <nav className="category-navbar">
      <h1>{featured ? `${featured} (${totalProducts})` : `Featured (${totalProducts})`}</h1>
...
export default CategoryFeaturedBar;
